            ...
            */
            ...
            insertDeleteLink = function(row) {
                ...
                if (row.is('TR')) {
                    ...
                    row.append('<li>' + delete_button + '</li>');
                } else if (row.is('TBODY')) {
                    // Insert in the last column of the first row in this tbody.
                    row.children(':first').children(':last').append(delete_button);
                } else {
